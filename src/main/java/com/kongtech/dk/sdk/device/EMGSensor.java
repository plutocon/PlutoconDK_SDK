...
public class EMGSensor extends PlutoconDK {
    ...
    public String getTypeString() {
        return PlutoconDK.TYPE_STRING_EMG;
    }

    @Override
    public int getType() {
        return PlutoconDK.TYPE_EMG;
    }
    ...
    public void dataReceiveCallback(byte[] data, PlutoconDKDataReceiver plutoconDKDataReceiver) {
        EMGDataReceiver receiver = (EMGDataReceiver) plutoconDKDataReceiver;
    ...
    public interface EMGDataReceiver extends PlutoconDKDataReceiver {
