...
public class AccelerationSensor extends Sensor {
    ...
    public String getTypeString() {
        return Sensor.TYPE_STRING_ACC;
    }

    @Override
    public int getType() {
        return Sensor.TYPE_ACC;
    }
    ...
    public void dataReceiveCallback(byte[] data, SensorDataReceiver sensorDataReceiver) {
        ...
        if (sensorDataReceiver != null) {
            AccelerationDataReceiver receiver = (AccelerationDataReceiver) sensorDataReceiver;
    ...
    public interface AccelerationDataReceiver extends SensorDataReceiver {
