...
public class SensorEditor {
    ...
    public SensorEditor(BluetoothGatt sensorGatt){
    ...
    public SensorEditor setProperty(ParcelUuid uuid, int value){
    ...
    public SensorEditor setProperty(ParcelUuid uuid, String value){
        BluetoothGattCharacteristic characteristic = characteristics.get(uuid);
    ...
    public SensorEditor setOnEditCompleteCallback(OnEditCompleteCallback onEditCompleteCallback) {
