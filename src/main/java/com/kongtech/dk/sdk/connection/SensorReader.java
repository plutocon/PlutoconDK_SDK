...
public class SensorReader {
    ...
    public SensorReader(BluetoothGatt sensorGatt){
    ...
    public SensorReader getProperty(ParcelUuid uuid){
    ...
    public SensorReader setOnReadCompleteCallback(OnReadCompleteCallback onReadCompleteCallback) {
